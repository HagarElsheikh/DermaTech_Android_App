...
public class AdapterForPatientArticle extends RecyclerView.Adapter<AdapterForPatientArticle.MedicalConsultantViewHolder> {
    ...
    public AdapterForPatientArticle(Context context, ArrayList<Article> articles) {
    ...
    public MedicalConsultantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_article_for_patient,parent,false);
        ...
        public MedicalConsultantViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(v.getContext(), ArticleDetailsForPatientActivity.class);
